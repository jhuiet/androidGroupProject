...
public class DisplaySquats extends AppCompatActivity implements TextView.OnEditorActionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_squats);

        // get references to the widgets
        tv = (TextView) findViewById(R.id.squatsTextView);
